...
FLATGLTF_1_0_FLATC_CPP_FLAGS=\
	--cpp --scoped-enums --gen-name-strings --gen-object-api --no-includes --gen-mutable \
	-I $(PROJECT_SCAFFOLDING)/thirdparty/flatgltf/schemas/1.0 \
	-o $(PROJECT_SCAFFOLDING)/thirdparty/flatgltf/include/flatgltf/1.0/
...
gen_flatgltf_1_0_headers:
	@$(PROJECT_SCAFFOLDING)/tools/bin/darwin/flatc \
		$(FLATGLTF_1_0_FLATC_CPP_FLAGS) \
		$(PROJECT_SCAFFOLDING)/thirdparty/flatgltf/schemas/1.0/glTF.fbs
	@clang-format -i $(PROJECT_SCAFFOLDING)/thirdparty/flatgltf/include/flatgltf/1.0/*_generated.h
...
gen_flatgltf_1_0_schema_headers:
	@$(BIN2CPPSTRING) \
		-f $(PROJECT_SCAFFOLDING)/thirdparty/flatgltf/schemas/1.0/glTF.fbs \
		-o $(PROJECT_SCAFFOLDING)/thirdparty/flatgltf/src/1.0/glTF.cxx \
		-n flatgltf_1_0_schema
